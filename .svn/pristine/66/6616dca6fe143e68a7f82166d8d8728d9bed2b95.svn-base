...
public class CalendarMonthAdapter extends RecyclerView.Adapter<CalendarMonthAdapter.ViewHolder>{
	...
	private final CalendarMonthCard.OnCellBackListener onCellClickListener;
    private CalendarMonthCard currentItem;
	private List<CustomDate> dataList;

	public CalendarMonthAdapter(Context context, CalendarMonthCard.OnCellBackListener onCellClickListener, TypedArray typedArray, List<CustomDate> dataList) {
