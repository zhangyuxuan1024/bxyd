package net.iclassmate.bxyd.view.ScanView;
...
import net.iclassmate.bxyd.view.zxinglib.CameraPreview;
import net.iclassmate.bxyd.view.zxinglib.CameraUtils;
import net.iclassmate.bxyd.view.zxinglib.DisplayUtils;
