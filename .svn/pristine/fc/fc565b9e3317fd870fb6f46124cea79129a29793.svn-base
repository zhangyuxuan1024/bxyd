...
public class TitlePopup extends PopupWindow {
	...
	//弹窗子类项选中时的监听
	private OnPopmenuItemClicked mItemOnClickListener;
...
//					textView.setHeight(120);
	 ...
	 * 设置监听事件
	 */
	public void setItemOnClickListener(OnPopmenuItemClicked onItemOnClickListener){
	 ...
	 *	功能描述：弹窗子类项按钮监听事件
	 */
	public static interface OnPopmenuItemClicked{
