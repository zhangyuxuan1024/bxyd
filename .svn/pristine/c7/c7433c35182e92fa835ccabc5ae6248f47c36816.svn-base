...
public class FooterLoadingLayout extends LoadingLayout {
    ...
    protected void onFail() {
        show(true);
        mProgressBar.setBackground(getResources().getDrawable(R.mipmap.ic_shibai));
        mHintView.setVisibility(View.VISIBLE);
        mHintView.setText("刷新失败");
    }
    ...
    protected void onSucceed() {
        show(true);
        mProgressBar.setBackground(getResources().getDrawable(R.mipmap.ic_chenggong));
        mHintView.setVisibility(View.VISIBLE);
        mHintView.setText("刷新成功");
    }
