...
import net.iclassmate.bxyd.adapter.emotion.EmotionGridViewAdapter;
import net.iclassmate.bxyd.adapter.emotion.EmotionPagerAdapter;
...
import net.iclassmate.bxyd.view.emotion.EmojiIndicatorView;
...
public class EmotiomComplateFragment extends BaseFragment {
    ...
    public void onResume() {
        super.onResume();
        MobclickAgent.onPageStart("EmotiomComplateFragment");
    }

    @Override
    public void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd("EmotiomComplateFragment");
    }
