...
import net.iclassmate.bxyd.bean.study.save.Bulletin;
...
public class SaveAdapter extends BaseAdapter {
    ...
    private List<BulletinItem> list;
    private int msgType;
    ...
    public SaveAdapter(Context context, List<BulletinItem> list) {
    ...
    public int getItemViewType(int position) {
        int ret = -1;
        BulletinItem item = list.get(position);
        String bulletinType = item.getStudyMessageItem().getBulletinType().toUpperCase();
    ...
    public View bindView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.img_head.setImageResource(R.mipmap.ic_geren_xuanren);
    ...
    public View bindViewForward(int i, View view, ViewGroup viewGroup) {
        ...
        holder.img_head.setImageResource(R.mipmap.ic_geren_xuanren);
        holder.img_head_forward.setImageResource(R.mipmap.ic_geren_xuanren);
...
//                        url = url.substring(0, index);
                    ...
                    Picasso.with(context).load(url).placeholder(R.mipmap.img_morentupian)
            ...
            if (id == null || id.equals("-1")) {
                holder.img.setImageResource(R.mipmap.img_shanchu_wenjian);
            }
            return view;
        }
