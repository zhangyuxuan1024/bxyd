 ...
 */
public class EmotionDisFragment extends BaseFragment implements View.OnClickListener, MessageCallback, DataCallback {
    //是否绑定当前Bar的编辑框的flag
    ...
    Handler handler = new Handler() {
        public void handleMessage(android.os.Message msg) {
            ...
            if (messagesAdapter != null && contentView != null) {
    ...
    protected void initView(View rootView) {
        ...
        bar_edit_text.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                if (type >= 0) {
                    PopWindowUtils.showPopupWindowPaste(v, mContext, bar_edit_text, targetId, Constant.CHAT_TYPE_GROUPCHAT);
                }
                return true;
            }
        });
            ...
            public void onSuccess(List<Message> messages) {
                if (messages != null) {
                    ...
                    for (int i = 0; i < messages.size(); i++) {
                        ...
                        if (message.getContent() instanceof TextMessage) {
                            RMessage rMessage1 = new RMessage(message);
                            TextMessage textMessage = (TextMessage) message.getContent();
