...
import net.iclassmate.bxyd.ui.activitys.study.openfile.OpenVideo2Activity;
...
public class CustomMediaController extends MediaController {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.mediacontroller_share:
                    if (type == 1) {
                        Intent intent = new Intent(context, StudyWindowActivity.class);
                        List<String> list = new ArrayList<String>();
                        list.add("保存到网盘");
                        intent.putStringArrayListExtra("list", (ArrayList<String>) list);
                        intent.putExtra("saveid", fid);
                        ...
                        list.add("是否确认删除文件删除");
                        intent.putStringArrayListExtra("list", (ArrayList<String>) list);
                        activity.startActivityForResult(intent, OpenVideo2Activity.RET_DEL);
                    } else if (type == 3) {
                        Intent intent = new Intent(context, StudyWindowActivity.class);
                        List<String> list = new ArrayList<String>();
                        list.add("转发到主页");
    ...
    protected View makeControllerView() {
        ...
        View v = ((LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate
                (getResources().getIdentifier("my_mediacontrol_layout", "layout", getContext().getPackageName()), this);
        ...
        img_right = (ImageView) findViewById(R.id.mediacontroller_share);
        img_right.setOnClickListener(backListener);
        //注册事件监听
