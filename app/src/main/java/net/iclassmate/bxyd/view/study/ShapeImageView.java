package net.iclassmate.bxyd.view.study;
...
public class ShapeImageView extends ImageView {
    ...
    private Bitmap drawShapeBitmap(Bitmap bmp, int radius) {
        ...
        Bitmap outputbmp = Bitmap.createBitmap(scaledBitmap.getWidth(), scaledBitmap.getHeight(), Config.ARGB_8888);
        ...
        if ("star".equals(shape_type)) {//如果绘制的形状为五角星形
            ...
            canvas.drawCircle(scaledBitmap.getWidth() / 2, scaledBitmap.getHeight() / 2, scaledBitmap.getWidth() / 2, paint);//绘制圆形
        }
        //设置Xfermode的Mode
