        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                if (NetWorkUtils.isNetworkAvailable(UIUtils.getContext())) {
                    ...
                    pullView.setImageResource(R.mipmap.ic_chenggong);
                } else {
                    pullView.setVisibility(VISIBLE);
                    refreshStateTextView.setText(R.string.refresh_fail_2);
                    pullView.setImageResource(R.mipmap.ic_shibai);
                }
                break;
            case FAIL:
            default:
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                if (NetWorkUtils.isNetworkAvailable(UIUtils.getContext())) {
                    ...
                    loadStateTextView.setText(R.string.refresh_fail_2);
                }
                //pullView.setImageResource(R.mipmap.ic_chenggong);
                break;
            case FAIL:
            default:
                ...
                //loadStateImageView.setBackgroundResource(R.mipmap.ic_shibai);
                break;
        }
    }
    ...
    private void changeState(int to) {
        ...
        switch (state) {
            case INIT:
                ...
                pullView.setImageResource(R.drawable.xsearch_msg_pull_arrow_down);
                mProgressBar.setVisibility(GONE);
                // 上拉布局初始状态
...
//                pullUpView.setVisibility(View.VISIBLE);
            ...
            case RELEASE_TO_LOAD:
                // 释放加载状态
                tvFooter.setText(R.string.release_to_load);
                //pullUpView.startAnimation(rotateAnimation);

                currState = RELEASE_TO_LOAD;
                break;
            case LOADING:
                // 正在加载状态
                //pullUpView.clearAnimation();
                ...
                tvFooter.setText(R.string.loading);

                currState = LOADING;
                break;
            case DONE:
                // 刷新或加载完毕，啥都不做
                //tvFooter.setText(R.string.load_succeed);
                currState = DONE;
                break;
        }
    }
    ...
    private void initView() {
        pullView = (ImageView) refreshView.findViewById(R.id.pull_to_refresh_header_arrow);
        refreshStateTextView = (TextView) refreshView
                .findViewById(R.id.pull_to_refresh_header_hint_textview);
        mProgressBar = (ProgressBar) refreshView.findViewById(R.id.pull_to_refresh_header_progressbar);

        // 初始化上拉布局
        mProgressBarFooter = (ProgressBar) loadmoreView.findViewById(R.id.pull_to_load_footer_progressbar);
        tvFooter = (TextView) loadmoreView.findViewById(R.id.pull_to_load_footer_hint_textview);
        loadStateTextView = (TextView) loadmoreView.findViewById(R.id.pull_to_load_footer_hint_textview);
    }
